export const locations = [
  {
    ...
    description: "Extensa duna de arena en el desierto de Fiambalá, conocida por sus formaciones surrealistas y eventos como el Dakar Rally.",
    mapSrc:
  ...
  },
  {
    ...
    description: "Museo que preserva la cultura local, mostrando historia, tradiciones y artefactos arqueológicos del desierto.",
    mapSrc:
  ...
  },
  {
    ...
    title: "Dunitas",
    description: "Formaciones rocosas de dunita, importantes para estudios geológicos del manto terrestre.",
    mapSrc:
  ...
  },
  {
    ...
    description: "Rocas esculpidas con grabados prehispánicos que muestran motivos zoomorfos y antropomórficos.",
    mapSrc:
  ...
  },
  {
    ...
    description: "Complejo de aguas termales con propiedades curativas, en un entorno desértico y montañoso.",
    mapSrc:
