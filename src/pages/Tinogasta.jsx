...
import { Modal, ModalOverlay, ModalContent, ModalHeader, ModalBody, ModalCloseButton, ModalFooter, useDisclosure, Image,  HStack, IconButton, Tooltip, Button,  } from "@chakra-ui/react";
        ...
        {selectedLocation && (
          <Modal isOpen={isOpen} onClose={onClose} size="lg">
            ...
            <ModalContent bg={modalBgColor} color={textColor}>
              ...
              <ModalCloseButton />
              <ModalBody>
                <Image src={selectedLocation.imgSrc} alt={selectedLocation.name} borderRadius="md" mb={2} aria-label={selectedLocation.name} transition="0.3s ease-in-out" />
