			...
			<div className='container mx-auto px-4 md:px-8 max-w-7xl'>
				...
				>
					...
					<div className='space-y-6'>
						<h1
							className="text-5xl md:text-6xl font-bold font-['JetBrains_Mono'] 
						...
						<p className='text-xl max-w-3xl mx-auto leading-relaxed'>
							Descubre Tinogasta, donde la tradición vitivinícola se une con
							paisajes impresionantes y una rica historia cultural.
						</p>
					</div>
				</motion.header>
